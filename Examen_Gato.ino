/**
 * CODIGO GATO DE SCHRÖDINGER
 * Código elaborado por Rafael Anguiano 
...
void entro(){
  ...
  digitalWrite(13, LOW);
  digitalWrite(13, LOW);
  digitalWrite(13, HIGH);   //Parpadeo 1
  digitalWrite(13, HIGH);   //Parpadeo 1
  digitalWrite(13, LOW);
  digitalWrite(13, LOW);
  digitalWrite(13, LOW);
  digitalWrite(13, HIGH);   //Parpadeo 2
  digitalWrite(13, HIGH);   //Parpadeo 2
  digitalWrite(13, LOW);
  digitalWrite(13, LOW);
  digitalWrite(13, LOW);
  digitalWrite(13, HIGH);   //Parpadeo 3
  digitalWrite(13, HIGH);   //Parpadeo 3
  digitalWrite(13, LOW);
  digitalWrite(13, LOW);
  digitalWrite(13, LOW);
...
void salio(){
  ...
  digitalWrite(13, LOW);
  digitalWrite(13, LOW);
  digitalWrite(13, HIGH);   //Parpadeo 4
  digitalWrite(13, HIGH);   //Parpadeo 4
  digitalWrite(13, LOW);
  digitalWrite(13, LOW);
  digitalWrite(13, LOW);
  digitalWrite(13, HIGH);   //Parpadeo 5
  digitalWrite(13, HIGH);   //Parpadeo 5
  digitalWrite(13, LOW);
  digitalWrite(13, LOW);
  digitalWrite(13, LOW);
